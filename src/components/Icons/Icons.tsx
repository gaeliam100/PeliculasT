...
export const GenderIcon = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="icon icon-tabler icons-tabler-outline icon-tabler-masks-theater"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export const ChevronIcon = ({isOpen=false}:Props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-chevron-dow ease-linear duration-300 transition-all ${!isOpen?'transform rotate-180':'transform rotate-0'}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      <path d="M6 9l6 6l6 -6" />
    </svg>
